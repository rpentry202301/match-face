...
const SelectHistoryContext = createContext<{month:string,department:number|null,skills:number[]}| undefined>(undefined);
const SelectHistoryDispatchContext = createContext<Dispatch<SelectHistoryAction>|undefined>(undefined)
const initialSelect = {month:"",department:null,skills:[]}
